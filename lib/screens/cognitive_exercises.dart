...
class _CognitiveExercisesScreenState extends State<CognitiveExercisesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Cognitive Exercises', style: GoogleFonts.poppins(color: Colors.white)),
  ...
  Widget _buildMenu() {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Text('Daily Brain Training', style: GoogleFonts.poppins(fontSize: 24, fontWeight: FontWeight.w700, color: const Color.fromRGBO(7, 82, 96, 1))),
          const SizedBox(height: 4),
          Text('Choose an exercise to train your brain', style: GoogleFonts.roboto(fontSize: 14, color: Colors.grey)),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Memorize these words', style: GoogleFonts.poppins(fontSize: 22, fontWeight: FontWeight.w700)),
              ...
              ElevatedButton(
                ...
                child: Text('I\'m Ready', style: GoogleFonts.poppins(fontSize: 18)),
              ),
            ],
          ),
        ),
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                _buildAnswerButton('No', Colors.red, () => _checkMemoryAnswer(false, current)),
                const SizedBox(width: 20),
                _buildAnswerButton('Yes', Colors.green, () => _checkMemoryAnswer(true, current)),
              ],
            ),
          ],
        ),
            ...
            children: [
              if (_questionIndex == 0) ...[
                ...
                ElevatedButton(
                  ...
                  child: Text('Start', style: GoogleFonts.poppins(fontSize: 20, fontWeight: FontWeight.bold)),
                ),
              ] else
                Text(
                  _reactionColor == Colors.green ? 'TAP NOW!' : 'Wait...',
  ...
  void _handleReactionTap() {
    if (_reactionColor == Colors.green) {
  ...
  Widget _buildAttentionTest() {
    ...
    final displayColors = [Colors.red, Colors.blue, Colors.green, Colors.orange, Colors.purple];
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                _buildAnswerButton('No', Colors.red, () => _checkAttention(false)),
                const SizedBox(width: 20),
                _buildAnswerButton('Yes', Colors.green, () => _checkAttention(true)),
              ],
            ),
          ],
        ),
  ...
  Future<void> _finishTest(String testType, {int reactionMs = 0}) async {
    ...
    setState(() {
      _testComplete = true;
      _feedback = _score >= 8 ? 'Excellent!' : _score >= 5 ? 'Good job!' : 'Keep practicing!';
    });
  }
        ...
        child: Column(
          ...
          children: [
            Icon(
              ...
              size: 80,
              color: _score >= 8 ? Colors.amber : _score >= 5 ? Colors.green : Colors.orange,
            ),
            const SizedBox(height: 16),
            Text(_feedback, style: GoogleFonts.poppins(fontSize: 28, fontWeight: FontWeight.bold)),
            const SizedBox(height: 8),
            Text('Score: $_score / 10', style: GoogleFonts.roboto(fontSize: 20, color: Colors.grey)),
            if (_correctAnswers > 0)
              Text('Correct: $_correctAnswers', style: GoogleFonts.roboto(fontSize: 16, color: Colors.grey)),
            const SizedBox(height: 32),
            SizedBox(
              width: double.infinity,
              child: ElevatedButton(
                ...
                child: Text('Back to Exercises', style: GoogleFonts.poppins(fontSize: 16)),
              ),
            ),
          ],
        ),
