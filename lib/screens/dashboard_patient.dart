      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: [
          NavigationDestination(
            ...
            selectedIcon: const Icon(Icons.home_rounded, color: Color.fromRGBO(7, 82, 96, 1), size: 32),
          ),
          NavigationDestination(
            icon: const Icon(Icons.medication_outlined, size: 32),
            label: translation(context).medications,
            selectedIcon: const Icon(Icons.medication, color: Color.fromRGBO(7, 82, 96, 1), size: 32),
          ),
          NavigationDestination(
            icon: const Icon(Icons.analytics_outlined, size: 32),
            label: translation(context).statistics,
            selectedIcon: const Icon(Icons.analytics_rounded, color: Color.fromRGBO(7, 82, 96, 1), size: 32),
          ),
          NavigationDestination(
            icon: const Icon(Icons.dashboard_customize_outlined, size: 32),
            label: translation(context).more,
            selectedIcon: const Icon(Icons.dashboard_customize_rounded, color: Color.fromRGBO(7, 82, 96, 1), size: 32),
          ),
        ],
